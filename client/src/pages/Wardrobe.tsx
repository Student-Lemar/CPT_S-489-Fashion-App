...
export default function Wardrobe() {
  ...
  if (loading)
    return (
      <div className="page">
        <div className="container">Loading wardrobe…</div>
      </div>
    );
    ...
    <div className="page">
      <div className="container">
        <div className="page-header">
          ...
          <Link className="primary-link" to="/wardrobe/add">
            + Add Item
          </Link>
        </div>
                ...
                <div className="item-body">
                  ...
                  <div className="item-actions">
                    <Link
                      ...
                      to={`/wardrobe/${encodeURIComponent(item.id)}`}
                    >
                      View
                    </Link>
                    <Link
                      className="action-link"
                      to={`/wardrobe/${encodeURIComponent(item.id)}?mode=edit`}
                    >
                      Edit
                    </Link>
                  </div>
